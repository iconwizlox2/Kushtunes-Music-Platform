"use strict";(()=>{var e={};e.id=100,e.ids=[100],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},2438:(e,t,a)=>{a.r(t),a.d(t,{headerHooks:()=>l,originalPathname:()=>$,requestAsyncStorage:()=>u,routeModule:()=>i,serverHooks:()=>c,staticGenerationAsyncStorage:()=>d,staticGenerationBailout:()=>h});var s={};a.r(s),a.d(s,{POST:()=>POST});var r=a(884),o=a(6132),n=a(6113),p=a.n(n);function isoNow(){return new Date().toISOString().replace(/[:\-]|\.\d{3}/g,"")}async function POST(e){try{let{filename:t,contentType:a}=await e.json(),s=process.env.S3_BUCKET,r=process.env.S3_REGION,o=process.env.S3_ENDPOINT.replace(/^https?:\/\//,""),n=process.env.S3_ACCESS_KEY_ID,i=process.env.S3_SECRET_ACCESS_KEY,u=`releases/${Date.now()}-${t}`,d=`${s}.${o}`,c=`https://${d}/${u}`,l=isoNow(),h=l.slice(0,8),$="AWS4-HMAC-SHA256",g=`${h}/${r}/s3/aws4_request`,S="content-type;host;x-amz-content-sha256;x-amz-date",_="UNSIGNED-PAYLOAD",m=`content-type:${a}
host:${d}
